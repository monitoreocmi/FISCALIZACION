...
# =================================================================
# ID: SCRIPT DE GENERACIÓN DE REPORTES DE INCIDENCIAS V3.2
# FUNCIÓN: Análisis de desempeño, incidencia "OTRAS" (0%) y LINKS RESTAURADOS.
# =================================================================
...
def generar_reporte_v30_final():
    try:
        print("\n" + "="*60)
        print(">>> INICIANDO GENERACIÓN DE REPORTES V3.2 (INCIDENCIAS) <<<")
        print("="*60)
        ...
        if lista_df:
            ...
            print(f"[*] Periodos detectados: {[str(p) for p in periodos]}")
        else:
        ...
        for p_act in periodos:
            ...
            for i, n_s in enumerate(sucursales_txt, 1):
                ...
                sys.stdout.write(f"\r    -> ({i}/{len(sucursales_txt)}) Sucursal: {n_s_limpio} ... ")
                sys.stdout.flush()
                ...
                # RESTAURACIÓN DE LINKS EN TOTALES
                ...
                # reporte.html (Con links en el pie de tabla)
